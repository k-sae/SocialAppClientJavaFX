...
public class PostViewer extends VBox {
    ...
    private void setLayout(){
        ...
        thumbsUp.setOnMouseEntered(event -> thumbsUp.setStyle("-fx-font: 12 arial; -fx-background-color: #999999; -fx-text-fill: #000000;"));
        thumbsUp.setOnMouseExited(event -> thumbsUp.setStyle("-fx-font: 12 arial; -fx-background-color: #ffffff; -fx-text-fill: #000000;"));
        ...
        thumbsDown.setOnMouseEntered(event -> thumbsDown.setStyle("-fx-font: 12 arial; -fx-background-color: #999999; -fx-text-fill: #000000;"));
        thumbsDown.setOnMouseExited(event -> thumbsDown.setStyle("-fx-font: 12 arial; -fx-background-color: #ffffff; -fx-text-fill: #000000;"));
        ...
        comment.setOnMouseEntered(event -> comment.setStyle("-fx-font: 12 arial; -fx-background-color: #999999; -fx-text-fill: #000000;"));
        comment.setOnMouseExited(event -> comment.setStyle("-fx-font: 12 arial; -fx-background-color: #ffffff; -fx-text-fill: #000000;"));
        ...
        share.setOnMouseEntered(event -> share.setStyle("-fx-font: 12 arial; -fx-background-color: #999999; -fx-text-fill: #000000;"));
        share.setOnMouseExited(event -> share.setStyle("-fx-font: 12 arial; -fx-background-color: #ffffff; -fx-text-fill: #000000;"));
